...
-- Module: files
     ...
     OpenUnfoldFile OpenTransrelFile
...
-- Module: main
   ...
   SQLWanted SALWanted FDRWanted RTTWanted UnfoldGenericRulesPropsWanted
   UnfoldGenericVariableRefsWanted UnfoldTransCollectionNamesWanted
   TransformToTransrelWanted
   SetUnfoldGenVarRefs SetUnfoldGenRulesProps SetSAL
...
'action' String_to_int(STRING -> INT)
'condition' Is_number(STRING)
----------------------------------------------------------------------------
-- Module: files
----------------------------------------------------------------------------
...
'action' OpenUnfoldFile(IDENT -> STRING)
'action' OpenTransrelFile(IDENT -> STRING)
...
'condition' FDRWanted
'condition' RTTWanted
'condition' UnfoldTransCollectionNamesWanted
'condition' UnfoldGenericRulesPropsWanted
'condition' UnfoldGenericVariableRefsWanted
'condition' TransformToTransrelWanted
'action' SetUnfoldGenRulesProps
'action' SetUnfoldGenVarRefs
'action' SetSAL
'end'
