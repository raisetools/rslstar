...
-- Actions
  ...
  Get_env_transition_rules Get_current_transition_rules Set_current_transition_rules
  Get_Transition_Rule
...
'action' Get_current_env_types(CLASS_ENV -> TYPE_ENV)
  ...
  'rule' Get_current_env_types(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC,_,_,_,WITH, AD) -> TYP):
...
'action' Get_env_types(CLASS_ENV -> TYPE_ENV)
  ...
  'rule' Get_env_types(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _,WITH, AD) -> TYP):
...
'action' Set_current_env_types(CLASS_ENV, TYPE_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_types(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), TYP1 ->
                                      basic_env(TYP1, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_current_env_values(CLASS_ENV -> VALUE_ENVS)
  ...
  'rule' Get_current_env_values(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR,_, WITH, AD) -> VAL):

  'rule' Get_current_env_values(instantiation_env(PF, CE) -> VAL):
         Get_current_env_values(CE -> VAL)

  /* Added for unfolding of only the extending class - TODO: anything else needed here? */
  'rule' Get_current_env_values(extend_env(FCL,SCL,WITH,AD) -> VAL):
         Get_current_env_values(SCL -> VAL)
...
'action' Get_env_top_values(CLASS_ENV -> Value_ids)
  ...
  'rule' Get_env_top_values(basic_env(TYP, list(VE,VES), VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> VE):
...
'action' Set_current_env_values(CLASS_ENV, VALUE_ENVS -> CLASS_ENV)
  ...
  'rule' Set_current_env_values(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop,  WITH, AD), VAL1 ->
                                      basic_env(TYP, VAL1, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_current_env_variables(CLASS_ENV -> VARIABLE_ENV)
  ...
  'rule' Get_current_env_variables(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> VAR):
...
'action' Get_env_variables(CLASS_ENV -> VARIABLE_ENV)
  ...
  'rule' Get_env_variables(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> VAR)
...
'action' Set_current_env_variables(CLASS_ENV, VARIABLE_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_variables(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), VAR1 ->
                                      basic_env(TYP, VAL, VAR1, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_current_env_channels(CLASS_ENV -> CHANNEL_ENV)
  ...
  'rule' Get_current_env_channels(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> CH):
...
'action' Get_env_channels(CLASS_ENV -> CHANNEL_ENV)
  ...
  'rule' Get_env_channels(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> CH):
...
'action' Set_current_env_channels(CLASS_ENV, CHANNEL_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_channels(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), CH1 ->
                                      basic_env(TYP, VAL, VAR, CH1, MOD, AX, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_current_env_modules(CLASS_ENV -> MODULE_ENV)
  ...
  'rule' Get_current_env_modules(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> MOD):
...
'action' Get_env_modules(CLASS_ENV -> MODULE_ENV)
  ...
  'rule' Get_env_modules(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD) -> MOD):
...
'action' Set_current_env_modules(CLASS_ENV, MODULE_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_modules(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), MOD1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD1, AX, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_current_env_axioms(CLASS_ENV -> AXIOM_ENV)
  ...
  'rule' Get_current_env_axioms(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR,_, WITH, AD) -> AX):
...
'action' Get_env_axioms(CLASS_ENV -> AXIOM_ENV)
  ...
  'rule' Get_env_axioms(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> AX):
...
'action' Set_current_env_axioms(CLASS_ENV, AXIOM_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_axioms(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), AX1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX1, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_env_test_cases(CLASS_ENV, ALL_TOP -> TEST_CASE_ENV)
  ...
  'rule' Get_env_test_cases(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD), AT -> TC):
...
'action' Set_current_env_test_cases(CLASS_ENV, TEST_CASE_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_test_cases(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), TC1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX, TC1, TS, TR, Prop, WITH, AD)):
...
'action' Get_env_transition_systems(CLASS_ENV, ALL_TOP -> TRANS_SYS_ENV)
  ...
  'rule' Get_env_transition_systems(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC,TS, TR, _, WITH, AD), AT -> TS):
...
'action' Set_current_env_transition_system(CLASS_ENV, TRANS_SYS_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_transition_system(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), TS1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS1, TR, Prop, WITH, AD)):
...
--------------------------------------------------------------------------------------------------------
-- Transition rule collections environment handling
--------------------------------------------------------------------------------------------------------
'action' Get_current_transition_rules(ALL_TOP -> TRANS_RULE_ENV)

  'rule' Get_current_transition_rules(AT -> TR):
         Get_current_env(-> CE)
         Get_env_transition_rules(CE, AT -> TR)

'action' Get_env_transition_rules(CLASS_ENV, ALL_TOP -> TRANS_RULE_ENV)

  'rule' Get_env_transition_rules(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD), AT -> TR):

-- ignore first part of extend if it is an instantiation and only top wanted
  'rule' Get_env_transition_rules(extend_env(instantiation_env(_,_), CE, WITH, AD), top -> TR):
	 Get_env_transition_rules(CE, top -> TR)

  'rule' Get_env_transition_rules(extend_env(CE1, CE2, WITH, AD), AT -> TR):
         Get_env_transition_rules(CE1, AT -> TR1)
         Get_env_transition_rules(CE2, AT -> TR2)
	 -- sml translator assumes test cases in reverse order
         Trans_rule_env_concat(TR2, TR1 -> TR)

  'rule' Get_env_transition_rules(instantiation_env(PF, CE), AT -> TR):
         Get_env_transition_rules(CE, AT -> TR)

'action' Trans_rule_env_concat(TRANS_RULE_ENV, TRANS_RULE_ENV -> TRANS_RULE_ENV)

  'rule' Trans_rule_env_concat(trans_rule_env(I, TR1), TR2 -> trans_rule_env(I,TR)):
         Trans_rule_env_concat(TR1, TR2 -> TR)

  'rule' Trans_rule_env_concat(nil, TR -> TR):

'action' Set_current_transition_rules(TRANS_RULE_ENV)

  'rule' Set_current_transition_rules(TR1):
         Get_current_env(-> CE)
         Set_current_env_transition_rules(CE, TR1 -> CE1)
         Set_current_env(CE1)

'action' Set_current_env_transition_rules(CLASS_ENV, TRANS_RULE_ENV -> CLASS_ENV)

  'rule' Set_current_env_transition_rules(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), TR1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR1, Prop, WITH, AD)):

  'rule' Set_current_env_transition_rules(instantiation_env(PF, CE), TR -> instantiation_env(PF, CE1)):
         Set_current_env_transition_rules(CE, TR -> CE1)

-- Transition system look-up (inside environmet)

'action' Get_Transition_Rule(IDENT, TRANS_RULE_ENV -> OPT_TRANS_RULE_ID)
	 
  'rule' Get_Transition_Rule(Id, trans_rule_env(TRId, Rest) -> Result)
	 TRId'Ident -> TRIdent
	 (|
		eq(TRIdent, Id)
		where(tr_id(TRId) -> Result)
	 ||
		Get_Transition_Rule(Id, Rest -> Result)
	 |)

  'rule' Get_Transition_Rule(_, nil -> nil)
...
'action' Get_env_properties(CLASS_ENV, ALL_TOP -> PROPERTY_ENV)
  ...
  'rule' Get_env_properties(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), AT -> Prop):
...
'action' Set_current_env_property(CLASS_ENV, PROPERTY_ENV -> CLASS_ENV)
  ...
  'rule' Set_current_env_property(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD), Prop ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD)):
...
'action' Get_env_with(CLASS_ENV -> OBJECT_EXPRS)
  ...
  'rule' Get_env_with(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> WITH):
...
'action' Set_env_with(CLASS_ENV, OBJECT_EXPRS -> CLASS_ENV)
  ...
  'rule' Set_env_with(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), WITH1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH1, AD)):
...
'action' Get_env_adapts(CLASS_ENV -> ADAPTS)
  ...
  'rule' Get_env_adapts(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, _, WITH, AD) -> AD):
...
'action' Set_env_adapts(CLASS_ENV, ADAPTS -> CLASS_ENV)
  ...
  'rule' Set_env_adapts(basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD), AD1 ->
                                      basic_env(TYP, VAL, VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD1)):
...
'action' Start_extend_env(CLASS_ENV, OBJECT_EXPRS, PATH -> CLASS_ENV)
  ...
  'rule' Start_extend_env(CE, W, nil -> extend_env(CE, basic_env(nil,list(nil,nil),nil,nil,nil,nil,nil,nil,nil,nil,W,nil), W, nil)):
...
'action' Lookup_object_in_env(OBJECT_EXPR, CLASS_ENV, OWNENV -> OPT_OBJECT_ID)
  ...
  'rule' Lookup_object_in_env(obj_name(name(P, id_op(Id))), CE, Ownenv -> Oid):
         (|
           where(CE -> basic_env(_,_,_,_,ME,_,_,_,_,_,_,Ad))
           (|
             ne(Ownenv,ownenv)
...
'action' Check_implementation(POS, ADAPTS, CLASS_ENV, CLASS_ENV, ADAPTS, PARAM_FIT)
  ...
  'rule' Check_implementation(P, Fit, BCE, basic_env(TYP, list(VAL,VES), VAR, CH, MOD, AX, TC, TS, TR, _,WITH, AD), AD1, PFC):
         Concat_adapts(AD1, AD -> AD2)
...
'action' Unfold_types(CLASS_ENV, CLASS_ENV, ADAPTS, PARAM_FIT -> CLASS_ENV)
  ...
  'rule' Unfold_types(OCE, CE, AD1, PFC -> basic_env(TYP1, list(VAL1,VES), VAR1, CH1, MOD1, AX, TC, TS, TR, Prop, WITH, AD)):
         where(CE -> basic_env(TYP, list(VAL,VES), VAR, CH, MOD, AX, TC, TS, TR, Prop, WITH, AD))
         Concat_adapts(AD1, AD -> AD2)
...
'condition' Type_is_defined_in_class_env(Type_id, CLASS_ENV)
  ...
  'rule' Type_is_defined_in_class_env(I, basic_env(TYP,_,_,_,MOD,_,_,_,_,_,_,_)):
         (|
...
'condition' Variable_is_defined_in_class_env(Variable_id, CLASS_ENV)
  ...
  'rule' Variable_is_defined_in_class_env(I, basic_env(_,_,VARS,_,MOD,_,_,_,_,_,_,_)):
         (|
...
'condition' Channel_is_defined_in_class_env(Channel_id, CLASS_ENV)
  ...
  'rule' Channel_is_defined_in_class_env(I, basic_env(_,_,_,CHS,MOD,_,_,_,_,_,_,_)):
         (|
...
'condition' Object_is_defined_in_class_env(Object_id, CLASS_ENV)
  ...
  'rule' Object_is_defined_in_class_env(I, basic_env(_,_,_,_,MOD,_,_,_,_,_,_,_)):
...
'action' Unadapt_env_name(NAME, CLASS_ENV -> OPT_NAME)
  ...
  'rule' Unadapt_env_name(N, basic_env(_,_,_,_,_,_,_,_,_,_,_,AD) -> ON):
